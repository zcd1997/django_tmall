...
class Review(models.Model):
    ...
    uid = models.ForeignKey('UserProfile', models.DO_NOTHING, db_column='uid', db_index=True,
                             verbose_name='用户ID')
...
class PropertyValue(models.Model):
    ...
    shop_id = models.ForeignKey(Shop, on_delete=models.CASCADE, db_column='shop_id', verbose_name="商品ID")
    property_id = models.ForeignKey(Property, on_delete=models.CASCADE, db_column='property_id', verbose_name="属性ID")
...
class ShopCar(models.Model):
    ...
    shop = models.ForeignKey(Shop, models.DO_NOTHING, verbose_name='商品名称')
    uid = models.ForeignKey('UserProfile', models.DO_NOTHING, db_column='uid', verbose_name='用户ID')
    oid = models.ForeignKey('Order', on_delete=models.SET_NULL, db_column='oid', null=True, verbose_name='商品ID')
    # 1正常 -1 删除 ， 禁止 2
